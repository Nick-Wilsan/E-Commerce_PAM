// Alur baca:
// 1. LoginPage memanggil `appState.login(...)`.
// 2. AppState memanggil ApiService.
// 3. Setelah response sukses, AppState menyimpan user dan materi.
// 4. AppState menjalankan `notifyListeners()`.
// 5. UI seperti DashboardPage rebuild dan menampilkan data terbaru.
